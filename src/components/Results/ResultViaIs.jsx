                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-gray-200 p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-700 font-medium">Character Strengths & Virtues</p>
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4 mb-4">
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed">{viaExplanation.developer}</p>
                    </div>
                    <div className="bg-white p-4 rounded border border-blue-100">
                    <h4 className="font-semibold text-gray-900 mb-2">✅ Validitas Ilmiah</h4>
                    <p className="text-sm text-gray-700 leading-relaxed">{viaExplanation.validity}</p>
                    </div>
                  </div>

                  <div className="bg-white p-4 rounded border border-blue-100">
                    <h4 className="font-semibold text-gray-900 mb-2">🎯 Tujuan Assessment</h4>
                    <p className="text-sm text-gray-700 leading-relaxed">Assessment ini bertujuan untuk membantu Anda mengenali kekuatan karakter utama (signature strengths) yang dapat dioptimalkan dalam kehidupan pribadi maupun profesional.</p>
                  </div>
                </div>
              </div>
            </motion.div>
                ...
                <div className="bg-white rounded border border-slate-200 shadow-sm p-6">
                  ...
                  <div className="mt-6 grid grid-cols-2 md:grid-cols-3 gap-3">
                    {Object.entries(viaCategories).map(([key, category]) => {
                      ...
                      return (
                        <div key={key} className="text-center p-4 bg-slate-50 rounded border border-slate-200">
                          ...
                          <div className={`text-xs px-2 py-1 rounded ${scoreLevel.bg} ${scoreLevel.intensity}`}>
                            {scoreLevel.level}
                          </div>
                        </div>
                      );
            ...
            {result.assessment_data?.viaIs && (
              ...
              >
                <div className="bg-white rounded border border-slate-200 shadow-sm p-6">
                  ...
                  {/* Virtue Categories Cards - 3 columns 2 rows layout */}
                        ...
                        >
                          ...
                          <div className="p-6">
                            ...
                            <div className="mb-6 overflow-hidden">
                              <div className="bg-slate-200 rounded h-3 w-full max-w-full">
                                <motion.div
                            ...
                            <div className="mb-6">
                              ...
                              <div className="space-y-3">
                                {category.strengths.map((strength, idx) => {
                                  ...
                                  return (
                                    <div key={idx} className="flex items-center justify-between text-sm p-2 rounded bg-slate-50 border border-slate-200">
                                      ...
                                      <div className="flex items-center gap-2 flex-shrink-0">
                                        ...
                                        <span className={`text-xs px-2 py-1 rounded ${strengthLevel.bg} ${strengthLevel.intensity}`}>
                ...
                >
                  <div className="bg-white rounded border border-slate-200 shadow-sm p-6 overflow-hidden">
                    <div className="flex items-center mb-6">
                      <div className="w-10 h-10 bg-slate-100 rounded flex items-center justify-center mr-3 flex-shrink-0">
                      ...
                      {getViaIsInsights(result.assessment_data.viaIs, viaCategories, strengthLabels).top.map(([strength, score], idx) => {
                        return (
                          <motion.div
                            ...
                            className="p-4 rounded border border-slate-200 bg-slate-50 overflow-hidden"
                          >
                            <div className="flex justify-between items-start mb-2">
                              ...
                              <span className="text-sm px-3 py-1 rounded bg-slate-600 text-white flex-shrink-0 font-bold">
                                {score.toFixed(2)}
                              </span>
                            </div>
                            ...
                            <div className="bg-slate-200 rounded h-2.5 overflow-hidden">
                              <motion.div
                                className="bg-slate-600 h-2.5 rounded"
                                initial={{ width: 0 }}
            ...
            >
              <div className="bg-white rounded border border-slate-200 shadow-sm p-6">
                <div className="text-center mb-8">
                  <h3 className="text-2xl font-bold text-slate-900 mb-3">24 Character Strengths Explained</h3>
                  ...
                  {Object.entries(viaStrengthsData).map(([strengthKey, strengthData], index) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className={`bg-white rounded-lg border-2 p-5 hover:shadow-lg transition-all duration-300 ${
                          isSignature
                      ...
                      >
                        ...
                        <div className="mb-4">
                          ...
                          {/* Progress Bar */}
                          <div className="bg-slate-200 rounded h-2 mb-3">
                            <motion.div
                              className={`h-2 rounded ${isSignature ? 'bg-slate-600' : isHigh ? 'bg-slate-500' : 'bg-slate-400'}`}
                              initial={{ width: 0 }}
                        ...
                        <div className="space-y-3">
                          {strengthScore >= 3.0 ? (
                            <div>
                              <h5 className="text-sm font-semibold text-green-800 mb-2">Karakteristik Anda:</h5>
                            ...
                            <div>
                              <h5 className="text-sm font-semibold text-amber-800 mb-2">Area Pengembangan:</h5>
                          ...
                          <div className="bg-slate-50 rounded p-3 border border-slate-200">
                            <h5 className="text-sm font-semibold text-slate-800 mb-1">Implikasi Karier:</h5>
                ...
                <div className="mt-8 bg-slate-50 rounded-lg p-4 border border-slate-200">
                  <h4 className="text-sm font-semibold text-slate-900 mb-3">Panduan Interpretasi:</h4>
                ...
                <div className="bg-gray-50 border-b border-gray-100 px-8 py-6">
                  <div className="flex items-center mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 font-medium">Mengapa VIA Character Strengths Sangat Tepat untuk Assessment Karakter</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-gray-50 p-6 rounded-lg border border-gray-100">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <p className="text-sm text-gray-700 leading-relaxed">Kekuatan karakter mempengaruhi preferensi lingkungan kerja. Misalnya, individu dengan kekuatan "Leadership" tinggi cenderung tertarik pada tipe Enterprising, sementara "Love of Learning" berkorelasi dengan tipe Investigative.</p>
                      </div>
                      <div>
                        <h5 className="font-medium text-gray-900 mb-2">Dengan OCEAN (Kepribadian):</h5>
                        <p className="text-sm text-gray-700 leading-relaxed">Karakter dan kepribadian saling memperkuat. Kekuatan "Creativity" berkorelasi dengan Openness tinggi, "Perseverance" dengan Conscientiousness, dan "Social Intelligence" dengan Extraversion.</p>
                      </div>
                    </div>
                  </div>
                </div>
