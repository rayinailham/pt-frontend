...
const ResultViaIs = () => {
  ...
  const prepareRadarData = (viaIsData) => {
    ...
    const getStrengthValue = (data, strengthKey) => {
      const variations = [
        ...
        strengthKey === "appreciation_of_beauty"
    ...
    Object.entries(viaCategories).forEach(([categoryKey, category]) => {
      const strengthValues = category.strengths.map((strength) =>
      ...
      if (validValues.length > 0) {
        ...
        const avgScore =
          strengthValues.reduce((sum, val) => sum + val, 0) /
  ...
  const CustomRadarTooltip = ({ active, payload, label }) => {
    if (active && payload && payload.length) {
      ...
      const categoryKey = Object.keys(viaCategories).find(
        (key) => viaCategories[key].name === label
      );
  ...
  const navigationCards = [
    ...
    },
    {
      ...
      description:
        "Jelajahi minat karier dan preferensi lingkungan kerja Anda.",
              ...
              <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start mb-4 sm:mb-6">
                <div className="mb-4 lg:mb-0">
                  ...
                  <p className="text-sm sm:text-base text-gray-600 max-w-2xl">
                    Discover your signature character strengths based on the VIA
                    (Values in Action) Survey that represents your authentic
                    self.
                  </p>
                </div>
                <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3 lg:flex-shrink-0">
                  <button
                    ...
                    className="px-3 sm:px-4 py-2 border border-gray-300 text-gray-700 rounded hover:bg-gray-50 transition-colors text-sm flex items-center space-x-2 justify-center"
              ...
              <div className="bg-white rounded border border-gray-200 shadow-sm overflow-hidden">
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-gray-200 p-4 sm:p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4 text-sm sm:text-base">
                    VIA (Values in Action) Survey merupakan instrumen psikologi
                    positif yang bertujuan mengidentifikasi 24 karakter utama
                    manusia, yang dikelompokkan dalam 6 kategori kebajikan
                    universal. Hasil assessment ini dapat digunakan untuk
                    pengembangan diri, peningkatan kinerja, serta kesejahteraan
                    secara menyeluruh.
                  </p>
                  ...
                  <div className="bg-white p-3 sm:p-4 rounded border border-blue-100">
                    ...
                    <p className="text-xs sm:text-sm text-gray-700 leading-relaxed">
                      Assessment ini bertujuan untuk membantu Anda mengenali
                      kekuatan karakter utama (signature strengths) yang dapat
                      dioptimalkan dalam kehidupan pribadi maupun profesional.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="flex items-center mb-2 sm:mb-3">
                    ...
                    <div className="min-w-0">
                      <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-1">
                        Akurasi dan Validitas Assessment
                      </h2>
                      <p className="text-gray-600 font-medium text-sm sm:text-base">
                        Mengapa VIA Character Strengths Sangat Tepat untuk
                        Assessment Karakter
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="bg-gray-50 p-4 sm:p-6 rounded-lg border border-gray-100">
                      ...
                      <ul className="text-xs sm:text-sm text-gray-700 space-y-2 sm:space-y-3">
                        <li className="flex items-start">
                          ...
                          <span>
                            Dikembangkan melalui penelitian lintas budaya selama
                            3 tahun dengan 1 juta responden
                          </span>
                        </li>
                        <li className="flex items-start">
                          <span className="w-1 h-1 sm:w-1.5 sm:h-1.5 bg-gray-400 rounded-full mt-1.5 sm:mt-2 mr-2 sm:mr-3 flex-shrink-0"></span>
                          <span>
                            Validasi empiris di 54 negara dengan reliabilitas
                            test-retest tinggi (α &gt; 0.85)
                          </span>
                        </li>
                        <li className="flex items-start">
                          <span className="w-1 h-1 sm:w-1.5 sm:h-1.5 bg-gray-400 rounded-full mt-1.5 sm:mt-2 mr-2 sm:mr-3 flex-shrink-0"></span>
                          <span>
                            Berdasarkan analisis literatur filosofi dan agama
                            selama 2000+ tahun
                          </span>
                        </li>
                      </ul>
                    ...
                    <div className="bg-gray-50 p-4 sm:p-6 rounded-lg border border-gray-100">
                      ...
                      <ul className="text-xs sm:text-sm text-gray-700 space-y-2 sm:space-y-3">
                        <li className="flex items-start">
                          <span className="w-1 h-1 sm:w-1.5 sm:h-1.5 bg-gray-400 rounded-full mt-1.5 sm:mt-2 mr-2 sm:mr-3 flex-shrink-0"></span>
                          <span>
                            Mengukur karakter positif, bukan defisit atau
                            patologi
                          </span>
                        </li>
                        <li className="flex items-start">
                          <span className="w-1 h-1 sm:w-1.5 sm:h-1.5 bg-gray-400 rounded-full mt-1.5 sm:mt-2 mr-2 sm:mr-3 flex-shrink-0"></span>
                          <span>
                            Fokus pada kekuatan yang dapat dikembangkan dan
                            dioptimalkan
                          </span>
                        </li>
                        <li className="flex items-start">
                          <span className="w-1 h-1 sm:w-1.5 sm:h-1.5 bg-gray-400 rounded-full mt-1.5 sm:mt-2 mr-2 sm:mr-3 flex-shrink-0"></span>
                          <span>
                            Memberikan hasil yang actionable untuk pengembangan
                            diri
                          </span>
                        </li>
                      </ul>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                      <div>
                        <h5 className="font-medium text-gray-900 mb-2 text-sm sm:text-base">
                          Dengan RIASEC (Minat Karier):
                        </h5>
                        <p className="text-xs sm:text-sm text-gray-700 leading-relaxed">
                          Kekuatan karakter mempengaruhi preferensi lingkungan
                          kerja. Misalnya, individu dengan kekuatan "Leadership"
                          tinggi cenderung tertarik pada tipe Enterprising,
                          sementara "Love of Learning" berkorelasi dengan tipe
                          Investigative.
                        </p>
                      </div>
                      <div>
                        <h5 className="font-medium text-gray-900 mb-2 text-sm sm:text-base">
                          Dengan OCEAN (Kepribadian):
                        </h5>
                        <p className="text-xs sm:text-sm text-gray-700 leading-relaxed">
                          Karakter dan kepribadian saling memperkuat. Kekuatan
                          "Creativity" berkorelasi dengan Openness tinggi,
                          "Perseverance" dengan Conscientiousness, dan "Social
                          Intelligence" dengan Extraversion.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded border border-slate-200 shadow-sm p-4 sm:p-6">
                  <div className="text-center mb-4 sm:mb-6">
                    <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-2">
                      Virtue Categories Profile
                    </h3>
                    <p className="text-slate-600 text-xs sm:text-sm leading-relaxed">
                      Rata-rata skor Anda pada enam kategori kebajikan utama
                    </p>
                  </div>
                  ...
                  <div className="h-64 sm:h-80 lg:h-96">
                    <ResponsiveContainer width="100%" height="100%">
                      <RadarChart
                        data={prepareRadarData(result.assessment_data.viaIs)}
                      >
                  ...
                  <div className="mt-4 sm:mt-6 grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3">
                    {Object.entries(viaCategories).map(([key, category]) => {
                      const categoryData = prepareRadarData(
                        result.assessment_data.viaIs
                      ).find((item) => item.category === category.name);
                      const scoreLevel = getScoreLevel(
                        categoryData ? categoryData.fullValue : 0
                      );
                      return (
                        <div
                          key={key}
                          className="text-center p-2 sm:p-4 bg-slate-50 rounded border border-slate-200"
                        >
                          <div className="text-sm sm:text-lg font-bold mb-1 text-slate-900">
                            {categoryData
                              ? categoryData.fullValue.toFixed(2)
                              : "N/A"}
                          </div>
                          ...
                          <div
                            className={`text-xs px-1 sm:px-2 py-1 rounded ${scoreLevel.bg} ${scoreLevel.intensity}`}
                          >
                            {scoreLevel.level}
                          </div>
                        </div>
            ...
            {result.assessment_data?.viaIs && (
              ...
              >
                <div className="bg-white rounded border border-slate-200 shadow-sm p-4 sm:p-6">
                  <div className="text-center mb-4 sm:mb-6">
                    <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-2">
                      Virtue Categories Analysis
                    </h3>
                    <p className="text-slate-600 text-xs sm:text-sm leading-relaxed">
                      Analisis mendalam kekuatan karakter Anda berdasarkan
                      kategori kebajikan
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    {Object.entries(viaCategories).map(
                      ([categoryKey, category], index) => {
                        const categoryData = prepareRadarData(
                          result.assessment_data.viaIs
                        ).find((item) => item.category === category.name);
                        const categoryScore = categoryData
                          ? categoryData.fullValue
                          : 0;
                            ...
                            <div className="bg-slate-50 border-b border-slate-200 p-4 sm:p-6">
                              <div className="flex items-center justify-between">
                                <div className="flex items-center min-w-0 flex-1">
                                  <div className="min-w-0 flex-1">
                                    ...
                                    <p className="text-xs sm:text-sm text-slate-600">
                                      {category.strengths.length} Character
                                      Strengths
                                    </p>
                                  </div>
                                </div>
                                <div className="text-right flex-shrink-0 ml-2 sm:ml-4">
                                  ...
                                  <div
                                    className={`text-xs sm:text-sm ${scoreLevel.intensity}`}
                                  >
                                    {scoreLevel.level}
                                  </div>
                                </div>
                                  ...
                                  {category.strengths.map((strength, idx) => {
                                    ...
                                    const getStrengthValue = (
                                      ...
                                      const variations = [
                                        ...
                                        // Specific mappings for problematic fields
                                        strengthKey === "love_of_learning"
                                          ? "loveOfLearning"
                                          : null,
                                        strengthKey === "social_intelligence"
                                          ? "socialIntelligence"
                                          : null,
                                        strengthKey === "self_regulation"
                                          ? "selfRegulation"
                                          : null,
                                        strengthKey === "appreciation_of_beauty"
                                          ? "appreciationOfBeauty"
                                    ...
                                    const strengthScore = getStrengthValue(
                                      result.assessment_data.viaIs,
                                      strength
                                    );
                                    const strengthLabel =
                                    ...
                                    const strengthLevel =
                                      getScoreLevel(strengthScore);
                                    return (
                                      <div
                                        key={idx}
                                        className="flex flex-col sm:flex-row sm:items-center sm:justify-between text-xs sm:text-sm p-2 rounded bg-slate-50 border border-slate-200 space-y-1 sm:space-y-0"
                                      >
                                        <span className="text-slate-700 font-medium flex-1 min-w-0 break-words">
                                          {strengthLabel}
                                        </span>
                                        <div className="flex items-center gap-2 flex-shrink-0 self-start sm:self-auto">
                                          ...
                                          <span
                                            className={`text-xs px-1 sm:px-2 py-1 rounded ${strengthLevel.bg} ${strengthLevel.intensity}`}
                                          >
                                            {strengthScore >= 4.0
                                              ? "Signature"
                                              : strengthScore >= 3.5
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 mb-6 sm:mb-8 overflow-hidden min-w-0">
                ...
                >
                  <div className="bg-white rounded border border-slate-200 shadow-sm p-4 sm:p-6 overflow-hidden">
                    <div className="flex items-center mb-4 sm:mb-6">
                      ...
                      <h3 className="text-lg sm:text-xl font-bold text-slate-900 min-w-0">
                        Top 5 Signature Strengths
                      </h3>
                    </div>

                    <p className="text-slate-600 mb-4 sm:mb-6 text-xs sm:text-sm leading-relaxed">
                      Lima kekuatan karakter teratas berikut merupakan ciri
                      utama yang paling menonjol dalam diri Anda. Optimalkan
                      kekuatan ini dalam aktivitas sehari-hari maupun
                      pengembangan karier.
                    </p>
                ...
                >
                  <div className="bg-white rounded border border-slate-200 shadow-sm p-4 sm:p-6 overflow-hidden">
                    ...
                    <p className="text-slate-600 mb-4 sm:mb-6 text-xs sm:text-sm leading-relaxed">
                      Kekuatan karakter berikut memiliki skor lebih rendah,
                      namun tetap dapat dikembangkan sesuai kebutuhan dan tujuan
                      Anda. Pertimbangkan untuk memperkuat area ini demi
                      mendukung pertumbuhan pribadi secara optimal.
                    </p>
              ...
              <div className="bg-white rounded border border-slate-200 shadow-sm p-4 sm:p-6">
                <div className="text-center mb-6 sm:mb-8">
                  ...
                  <p className="text-slate-600 text-xs sm:text-sm leading-relaxed max-w-3xl mx-auto">
                    Berikut adalah penjelasan lengkap dari 24 kekuatan karakter
                    VIA yang dikelompokkan berdasarkan 6 kategori kebajikan
                    universal. Setiap kekuatan memiliki karakteristik unik yang
                    dapat membantu Anda memahami profil karakter secara
                    mendalam.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
                  {Object.entries(viaStrengthsData).map(
                    ([strengthKey, strengthData], index) => {
                      ...
                      const getStrengthValue = (data, strengthKey) => {
                        const variations = [
                          ...
                          strengthKey.toLowerCase(),
                          strengthKey.replace(/_/g, " ").toLowerCase(),
                          strengthKey.replace(/_([a-z])/g, (_, letter) =>
                            letter.toUpperCase()
                          ),
                          strengthKey === "love_of_learning"
                            ? "loveOfLearning"
                      ...
                      const strengthScore = result.assessment_data?.viaIs
                        ? getStrengthValue(
                            result.assessment_data.viaIs,
                            strengthKey
                          )
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="mb-3 sm:mb-4">
                            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-2 space-y-1 sm:space-y-0">
                              ...
                              <div className="text-left sm:text-right flex-shrink-0">
                                ...
                                <div
                                  className={`text-xs px-1 sm:px-2 py-1 rounded ${scoreLevel.bg} ${scoreLevel.intensity} inline-block`}
                                >
                          ...
                          <div className="space-y-2 sm:space-y-3">
                            {strengthScore >= 3.0 ? (
                              <div>
                                <h5 className="text-xs sm:text-sm font-semibold text-green-800 mb-1 sm:mb-2">
                                  Karakteristik Anda:
                                </h5>
                                <ul className="text-xs text-green-700 space-y-1">
                                  {strengthData.highTraits
                                    .slice(0, 3)
                                    .map((trait, idx) => (
                                      <li
                                        key={idx}
                                      ...
                                      >
                                        <span className="text-green-500 mr-1 flex-shrink-0">
                                          •
                                        </span>
                              ...
                              <div>
                                <h5 className="text-xs sm:text-sm font-semibold text-amber-800 mb-1 sm:mb-2">
                                  Area Pengembangan:
                                </h5>
                                <ul className="text-xs text-amber-700 space-y-1">
                                  {strengthData.lowTraits
                                    .slice(0, 3)
                                    .map((trait, idx) => (
                                      <li
                                        key={idx}
                                        className="flex items-start"
                                      >
                                        <span className="text-amber-500 mr-1 flex-shrink-0">
                                          •
                                        </span>
                                        <span className="leading-tight">
                                          {trait}
                            ...
                            <div className="bg-slate-50 rounded p-2 sm:p-3 border border-slate-200">
                              <h5 className="text-xs sm:text-sm font-semibold text-slate-800 mb-1">
                                Implikasi Karier:
                              </h5>
                              <p className="text-xs text-slate-600 leading-relaxed">
                                {strengthScore >= 3.0
                                  ? strengthData.implications.high
                                  : strengthData.implications.low}
                              </p>
                            </div>
                          </div>
                        </motion.div>
                ...
                <div className="mt-6 sm:mt-8 bg-slate-50 rounded-lg p-3 sm:p-4 border border-slate-200">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 text-xs">
                    <div className="flex items-center">
                      ...
                      <span>
                        <strong>Signature (4.0+):</strong> Kekuatan utama Anda
                      </span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-3 h-3 sm:w-4 sm:h-4 bg-slate-500 rounded mr-2 flex-shrink-0"></div>
                      <span>
                        <strong>High (3.5-3.9):</strong> Kekuatan yang
                        berkembang baik
                      </span>
                    </div>
                    <div className="flex items-center">
                      ...
                      <span>
                        <strong>Moderate (2.5-3.4):</strong> Kekuatan yang cukup
                      </span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-3 h-3 sm:w-4 sm:h-4 bg-slate-300 rounded mr-2 flex-shrink-0"></div>
                      <span>
                        <strong>Lower (&lt;2.5):</strong> Area pengembangan
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gradient-to-r from-gray-50 to-slate-50 rounded-md p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">
                <div className="text-center">
                  ...
                  <p className="text-slate-600 text-sm sm:text-base lg:text-lg max-w-2xl mx-auto leading-relaxed font-normal">
                    Lanjutkan eksplorasi untuk memahami berbagai aspek
                    kepribadian dan potensi karier Anda secara komprehensif.
                    Setiap assessment memberikan wawasan yang saling melengkapi
